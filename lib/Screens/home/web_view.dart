  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const Padding(
          padding: EdgeInsets.only(right: 50.0, top: 24, bottom: 24),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.end,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
...
Widget backdrop(BuildContext context) {
  return SizedBox(
    ...
    width: MediaQuery.of(context).size.width > 1700 ? 1700 : double.infinity,
    child: Stack(
      children: [
        Container(
          width: double.infinity,
          height:
              (MediaQuery.of(context).size.height - kToolbarHeight) / 1.7 - 50,
          decoration: const BoxDecoration(
            image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage(
